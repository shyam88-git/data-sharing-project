    ...
    var defaultSerializeQueryArgs = function(_c) {
      ...
      if (typeof cached === "string") {
        ...
        var stringified = JSON.stringify(queryArgs, function(key, value) {
          return (0, import_toolkit.isPlainObject)(value) ? Object.keys(value).sort().reduce(function(acc, key2) {
            acc[key2] = value[key2];
            return acc;
          }, {}) : value;
        });
      ...
      function buildQueryHooks(name) {
        ...
        var useQueryState = function(arg, _c2) {
          ...
          var selectDefaultResult = (0, import_react3.useMemo)(function() {
            return (0, import_toolkit2.createSelector)([
              select(stableArg),
          ...
          var querySelector = (0, import_react3.useMemo)(function() {
            return selectFromResult ? (0, import_toolkit2.createSelector)([selectDefaultResult], selectFromResult) : selectDefaultResult;
      ...
      function buildMutationHook(name) {
        return function(_c2) {
          ...
          var mutationSelector = (0, import_react3.useMemo)(function() {
            return (0, import_toolkit2.createSelector)([select({ fixedCacheKey, requestId: promise == null ? void 0 : promise.requestId })], selectFromResult);
